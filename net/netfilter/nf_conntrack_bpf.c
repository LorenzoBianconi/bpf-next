...
/* bpf_nf_ct_insert_entry - Add the provided entry into a CT map
 *
 ...
 */
const struct nf_conn *
bpf_nf_ct_insert_entry(struct nf_conn *nfct__ref, struct bpf_ct_opts *opts,
		       u32 opts__sz)
{
	int err;
...
BTF_ID(func, bpf_nf_ct_insert_entry)
